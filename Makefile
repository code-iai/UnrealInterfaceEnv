...
UNREALROOTPATH = /home/pmania/UnrealEngine
GAMEPROJECTFILE =/home/pmania/Documents/Unreal Projects/UnrealInterfaceEnv/UnrealInterfaceEnv.uproject

TARGETS = \
	UnrealInterfaceEnv-Linux-Debug  \
	UnrealInterfaceEnv-Linux-DebugGame  \
	UnrealInterfaceEnv-Linux-Shipping  \
	UnrealInterfaceEnv-Linux-Test  \
	UnrealInterfaceEnv \
	UnrealInterfaceEnvEditor-Linux-Debug  \
	UnrealInterfaceEnvEditor-Linux-DebugGame  \
	UnrealInterfaceEnvEditor-Linux-Shipping  \
	UnrealInterfaceEnvEditor-Linux-Test  \
	UnrealInterfaceEnvEditor \
...
UnrealInterfaceEnv-Linux-Debug:
	 $(PROJECTBUILD) UnrealInterfaceEnv Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealInterfaceEnv-Linux-DebugGame:
	 $(PROJECTBUILD) UnrealInterfaceEnv Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealInterfaceEnv-Linux-Shipping:
	 $(PROJECTBUILD) UnrealInterfaceEnv Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealInterfaceEnv-Linux-Test:
	 $(PROJECTBUILD) UnrealInterfaceEnv Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealInterfaceEnv:
	 $(PROJECTBUILD) UnrealInterfaceEnv Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealInterfaceEnvEditor-Linux-Debug:
	 $(PROJECTBUILD) UnrealInterfaceEnvEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealInterfaceEnvEditor-Linux-DebugGame:
	 $(PROJECTBUILD) UnrealInterfaceEnvEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealInterfaceEnvEditor-Linux-Shipping:
	 $(PROJECTBUILD) UnrealInterfaceEnvEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealInterfaceEnvEditor-Linux-Test:
	 $(PROJECTBUILD) UnrealInterfaceEnvEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealInterfaceEnvEditor:
	 $(PROJECTBUILD) UnrealInterfaceEnvEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
